...
class WoocommerceAPIDetails extends React.Component {
  render() {
          ...
          <div className="columns">
            <div className="column">
              <div className="columns">
                ...
                <div className="column is-8">Woocommerce crypto checkout</div>
              </div>
              <div className="columns">
                <div className="column is-4">
              ...
              {/* <div className="columns" style={{ marginTop: '4%' }}>
                <div className="column is-4"><strong>intimate receiving address</strong></div>
                <div className="column is-8">
                  <input
                    className="input"
                    type="text"
                    placeholder="intimate.io wallet address"
                  />
                </div>
              </div> */}
            </div>
...
export default WoocommerceAPIDetails;
